...
### What statistical factors best predict NFL team success (wins/losses)?
...
1. **Load required libraries and set up data parameters**

2. **Load team statistics data**

3. **Data exploration and cleaning**

4. **Calculate target variable (team success metric)**
...
7. **Regression/Classification analysis**
